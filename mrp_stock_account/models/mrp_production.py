...
class MrpProduction(models.Model):
    ...
    editing_state_of_raws = fields.Selection([
        ('draft', 'Draft'),
        ('done', 'Done')],
        ...
        for production in self:
            ...
            for move_raw in production.move_raw_ids:
                move_raw.write({
                    ...
                    'price_unit': move_raw.product_id.standard_price,
                    'name': production.name,
                    'propagate': False,
                    'group_id': production.procurement_group_id and production.procurement_group_id.id or False,
                    'location_dest_id': move_raw.product_id.property_stock_production.id,
                    'unit_factor': move_raw.product_uom_qty / production.product_qty or 0.0,
                    'quantity_done_store': False
                })
