...
class SaleOrder(models.Model):
    ...
    def _discount_total(self):
        self.disc_total = sum((line.product_uom_qty * line.price_unit * line.discount)/100 for line in self.order_line)
    ...
    def _total_alls(self):
        self.total_b4_disc = sum((line.product_uom_qty * line.price_unit) for line in self.order_line)